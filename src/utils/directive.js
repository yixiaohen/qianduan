...
Vue.directive('dialogDrag', {
  bind(el, binding, vnode, oldVnode) {
    ...
    dialogHeaderEl.ondblclick = e => {
      const htmlpan = document.querySelector('.htmlPane');
      ...
      if (isFullScreen === false) {
        ...
        if (htmlpan) {
          htmlpan.style.height = (dragDom.clientHeight) / 1.25 + 'px';
        }

        if (NoticeContent) {
          NoticeContent.style.height = (dragDom.clientHeight) / 1.35 + 'px';
        }
        ...
        dragDom.style.marginTop = '50px';

        if (htmlpan) {
          htmlpan.style.height = '400px';
        }

        if (NoticeContent) {
          NoticeContent.style.height = '400px';
        }
...
Vue.directive('adaptive', {
  bind(el, binding, vnode, oldVnode) {
    ...
    dialogHeaderEl.ondblclick = e => {
      const con = document.querySelector('.w-e-text-container');
      if (isFullScreen === false) {
        nowHight = dragDom.clientHeight;
        ...
        con.style.height = (dragDom.clientHeight) / 1.5 + 'px';
