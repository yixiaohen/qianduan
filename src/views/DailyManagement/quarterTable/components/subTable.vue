    ...
    <el-main>
      <div>
        <div>
          <el-table
            ref="multipleTable"
            :data="formLabelAlign.tableDataHeader"
            tooltip-effect="dark"
            style="width: 100%"
            size="small"
            border
          ...
          >
                ...
                <div v-if="row.index === 3">
                  ...
                  >
                    ...
                    <el-form-item label="使用抗菌药物人次">
                      <el-input
                        v-model="
                          formLabelAlign.tableDatas.table3.AntibacterialNum
                        "
                        style="width: 200px"
                      />
                    </el-form-item>
                    <el-form-item label="抗菌药物使用比例">
                      <el-input
                        v-model="
                          formLabelAlign.tableDatas.table3
                            .AntibacterialProportion
                        "
                        style="width: 200px"
                      />
                    </el-form-item>
                      ...
                      <el-table-column label="检查项目" min-width="240px">
                        <template slot-scope="{ row }">
                          <el-checkbox-group v-model="row.CheckItem">
                            ...
                            <el-checkbox
                              label="9、一次性输血耗材无害化处理★,"
                            />
                            <el-checkbox label="10、按规定流程领血★," />
                            <el-checkbox
                              label="11、输血前、中、后全程监测患者★,"
                            />
                ...
                <div v-if="row.index === 15">
                  ...
                  >
                    ...
                    <el-form-item label="存在医疗纠纷" :required="true">
                      <el-input
                        v-model="
                          formLabelAlign.tableDatas.table15.MedicalDispute
                        "
                        style="width: 150px"
                      ><i
                        slot="suffix"
                    ...
                    <el-form-item label="根本原因分析">
                      <el-input
                        v-model="
                          formLabelAlign.tableDatas.table15.CauseAnalysis
                        "
                        style="width: 150px"
                        type="textarea"
                      />
                  ...
                  >
                    ...
                    >
                      <template>
                        <el-input
                          v-model.trim="
                            formLabelAlign.tableDatas.table16.DeptTotal
                          "
                          placeholder="科室发生总数"
                          clearable
                          size="mini"
                    ...
                    <el-table-column min-width="150px">
                      <template>
                        <el-checkbox-group
                          v-model="
                            formLabelAlign.tableDatas.table16.CauseAnalysis
                          "
                          label="根本原因分析"
                        >
                    ...
                    >
                      <template>
                        <el-input
                          v-model.trim="
                            formLabelAlign.tableDatas.table16.Summary
                          "
                          type="textarea"
            ...
            <el-table-column
              label="科室季度质量安全管理小组指标分析暨持续质量改进记录"
              min-width="135"
              prop="Text"
            />
            <el-table-column label="审核人（ 科主任 ）">
              <template slot-scope="{ row }">
                {{
                  CheckUserNameArr[row.tableIndex]
                    ? CheckUserNameArr[row.tableIndex].Step1CheckUserName
                    : ''
                }}
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="{ row }">
                <span
                  :style="{
                    color: CheckUserNameArr[row.tableIndex]
                      ? CheckUserNameArr[row.tableIndex].Step1State === '通过'
                        ? 'green'
                        : 'black'
                      : 'black',
                  }"
                >
                  {{
                    CheckUserNameArr[row.tableIndex]
                      ? CheckUserNameArr[row.tableIndex].Step1State
                      : '未审核'
                  }}
                </span>
              </template>
            </el-table-column>
            <el-table-column label="审核意见（科主任）">
              <template slot-scope="{ row }">
                <span>
                  {{
                    CheckUserNameArr[row.tableIndex]
                      ? CheckUserNameArr[row.tableIndex].Step1Feedback
                      : ''
                  }}
                </span>
              </template>
            </el-table-column>
            <el-table-column label="审核人（ 主管 ）">
              <template slot-scope="{ row }">
                {{
                  CheckUserNameArr[row.tableIndex]
                    ? CheckUserNameArr[row.tableIndex].Step2CheckUserName
                    : ''
                }}
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="{ row }">
                <span
                  :style="{
                    color: CheckUserNameArr[row.tableIndex]
                      ? CheckUserNameArr[row.tableIndex].Step2State === '通过'
                        ? 'green'
                        : 'black'
                      : 'black',
                  }"
                >
                  {{
                    CheckUserNameArr[row.tableIndex]
                      ? CheckUserNameArr[row.tableIndex].Step2State
                      : '未审核'
                  }}
                </span>
              </template>
            </el-table-column>
            <el-table-column label="审核意见（主管）">
              <template slot-scope="{ row }">
                <span>
                  {{
                    CheckUserNameArr[row.tableIndex]
                      ? CheckUserNameArr[row.tableIndex].Step2Feedback
                      : ''
                  }}
                </span>
              </template>
            </el-table-column>
            <el-table-column label="质管留言">
              <template slot-scope="{ row, $index }">
                <el-input
                  v-if="editColumn.index == $index"
                  v-model="editColumn.MessageContent"
                  type="textarea"
                  placeholder="请输入内容"
                />
                <span v-else>
                  {{
                    CheckUserNameArr[row.tableIndex]
                      ? CheckUserNameArr[row.tableIndex].MessageContent
                      : ''
                  }}
                </span>
              </template>
    ...
    >
      <el-form label-position="top" label-width="80px" size="mini">
        <el-form-item label="审核">
          <el-radio-group v-model="QuarterlyFormCheckVal.State" size="small">
            <el-radio-button label="通过" />
            <el-radio-button label="退回" />
          </el-radio-group>
        </el-form-item>
        <el-form-item label="审核意见">
          <el-input v-model="QuarterlyFormCheckVal.Feedback" type="textarea" />
        </el-form-item>
        <el-form-item>
          <el-button
            type="success"
            size="small"
            plain
            @click="InsertQuarterlyFormCheck"
          >提交
          </el-button>
          <el-button
            type="info"
...
<script>
import {
  InsertQuarterlyFormCheck,
  InsertQuarterlyFormDetail,
  InsertQuarterlyFormMessage,
  SelectQuarterlyFormAllocationDetail
...
export default {
  ...
  data() {
    return {
      ...
      tableDataHeader: [
        ...
        {
          index: 3,
          Text: '3、科室药品管理相关指标自查表'
        },
        {
          index: 4,
          Text: '4、（外科）重大疑难手术审批自查表'
        },
        {
          index: 5,
          Text: '5、科室危急值制度执行情况自查表'
        },
        {
          index: 6,
          Text: '6、科室医务人员技术权限执行情况自查表'
        },
        {
          index: 7,
          Text: '7、科室抗菌药物预防应用自查表'
        },
        {
          index: 8,
          Text: '8、国家基本药物使用自查表'
        ...
        {
          index: 9,
          Text: '9、诊疗指南与技术操作规范自查表'
        },
        {
          index: 10,
          Text: '10、季度运行病历书写质控总结记录'
        },
        {
          index: 11,
          Text: '11、病历首页质量存在问题归类及归档率'
        },
        {
          index: 12,
          Text: '12、季度输血病历书写规范性自查'
        },
        {
          index: 13,
          Text: '13、季度合理用血情况自查记录'
        },
        {
          index: 14,
          Text: '14、季度对患者的出院指导与随访工作评价分析总结记录'
        },
        {
          index: 15,
          Text: '15、季度住院时间超过30天患者评价分析总结记录'
        },
        {
          index: 16,
          Text: '16、（外科）季度非计划再次手术评价分析总结记录'
        },
        {
          index: 17,
          Text: '17、季度药事和药物使用质量管理评价分析记录'
        },
        {
          index: 18,
          Text: '18、季度患者合法权益科室自查总结分析记录'
        },
        {
          index: 19,
          Text: '19、季度疼痛管理季度自查'
      ...
      CheckUserNameArr: [],
      dialog: false,
      QuarterlyFormCheckVal: {
        State: '通过',
        Feedback: '',
        QuarterlyFormID: this.header.QuarterlyFormID,
        TableIndex: '',
        Step: this.step /* 层级（1：科主任 2：主管） */,
        CrateUserID: window.userInfo[0].UserID
      },
      editColumn: {
        index: -1,
        TableIndex: 0,
  ...
  mounted() {
    this.formLabelAlign.tableDataHeader = [];
    this.tableDataHeader.map((item, index) => {
      this.tableIndex.map(item2 => {
        if (item.index === item2) {
          this.formLabelAlign.tableDataHeader.push({
            ...item,
            tableIndex: index
          });
        }
  ...
  methods: {
    ...
    async SelectQuarterlyFormAllocationDetail(QuarterlyFormID = 0) {
      const { data } = await SelectQuarterlyFormAllocationDetail({
        QuarterlyFormID: QuarterlyFormID
      });
      this.CheckUserNameArr = data;
    },
    ...
    toExamineDialog(row) {
      this.QuarterlyFormCheckVal.TableIndex = row.index;
      this.dialog = true;
    },
    async InsertQuarterlyFormCheck() {
      const { data, code } = await InsertQuarterlyFormCheck(
        this.QuarterlyFormCheckVal
      );
      code === 200
        ? this.$message.success('审核成功')
        : this.$message.error('审核失败');
      this.SelectQuarterlyFormAllocationDetail(
        this.QuarterlyFormCheckVal.QuarterlyFormID
      );
      this.dialog = false;
    },
    async rowClick(row, column) {
      ...
      if (this.editColumn.index != -1 && this.editColumn.MessageContent != '') {
        await InsertQuarterlyFormMessage(this.editColumn);
        this.SelectQuarterlyFormAllocationDetail(this.header.QuarterlyFormID);
      }
      if (column.label === '质管留言') {
        this.editColumn.index = row.index - 1;
        this.editColumn.MessageContent = this.CheckUserNameArr[
          row.index - 1
        ].MessageContent;
        this.editColumn.QuarterlyFormID = this.header.QuarterlyFormID;
        this.editColumn.TableIndex = row.index;
      } else {
        this.editColumn.index = -1;
      }
    }
  }
};
