    ...
    >
      <el-form label-position="right">
        <el-form-item label="状态">
          ...
          >
            <el-option label="当事科室未核中" value="当事部门未审核" />
            <el-option label="当事科室审核中" value="当事部门审核中" />
            <el-option label="当事科室已审核" value="当事部门已审核" />
          </el-select>
        </el-form-item>
  ...
  methods: {
    ...
    UpdateReport(row) {
      this.UpdateFirstCentralizeDepartmentData.EventReportID =
        row.EventReportID;
      const EventReportID = row.FirstCentralizeDepartmentID;
