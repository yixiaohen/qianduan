  ...
  <div class="EvaluationOne">
    <el-card class="box-card">
      ...
      <div class="content">
        ...
        >
          ...
          <el-table-column label="评审结果" width="100" prop="Grade">
            <template v-if="gradeType" slot-scope="{ row }">{{
              row.CurrentGrade
            }}</template>
          ...
          <el-table-column label="最终结果" prop="Grade" />
          ...
          <el-table-column label="评审日期" width="150" prop="CreateDate" />
          ...
          <el-table-column label="整改时间" width="150" prop="RectifyEndTime">
            <template slot-scope="{ row }">{{
    ...
    >
      <el-tabs v-model="activeName" type="card">
        ...
        <el-tab-pane label="材料审核" name="first">
          <el-card style="height: 450px">
            ...
            >
              ...
              <!-- <el-table-column
                v-if="ReviewRow.CatalogType === 1 || ReviewRow.CatalogType === 3"
              ...
              <el-table-column label="审核" fixed="right" align="center">
                <template slot-scope="scope">
                  <el-button
                    size="mini"
                    icon="el-icon-s-check"
        ...
        <el-tab-pane label="科室自评" name="second">
          <el-card style="height: 380px; overflow-y: auto">
            <el-form
              ref="form1"
              :rules="rules"
...
export default {
  ...
  methods: {
    ...
    async UpdateRevoke(row) {
      const isAuditType = row.isAudit.includes(this.menu_one.replace('审核', ''));
      if (!isAuditType) {
        this.$message({
          type: 'warning',
          message: '未到当前级不可撤销！'
