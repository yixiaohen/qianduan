  ...
  <el-container>
    ...
    <el-container>
      <el-aside width="400px" height="calc(100vh - 100px)">
        ...
        >
          <el-table-column align="center" label="医疗服务能力">
...
export default {
  data() {
    return {
      ...
      tableLint1: [
        1111, 1407, 1500, 123, 3217, 544, 600
      ],
      tableLint2: [
        1271, 120, 1300, 1217, 312, 564, 700
      ]
  ...
  methods: {
    ...
    createEcharts() {
      const main_ = echarts.init(this.$refs.echatsRef, 'light');
      this.option = {
        tooltip: {
          trigger: 'axis',
          axisPointer: {
