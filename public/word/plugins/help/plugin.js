...
(function () {
    ...
    var tab$2 = function (editor) {
      var availablePlugins = function () {
        ...
        return '<div data-mce-tabstop="1" tabindex="-1">' + '<p><b>' + global$2.translate('Premium plugins:') + '</b></p>' + '<ul>' + premiumPluginList + '<li class="tox-help__more-link" "><a href="https://www.ts.com/pricing/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" target="_blank">' + global$2.translate('Learn more...') + '</a></li>' + '</ul>' + '</div>';
      };
      ...
      var maybeUrlize = function (editor, key) {
        return find(urls, function (x) {
          ...
          return makeLink({
            name: x.name,
            url: 'https://www.ts.com/docs/plugins/' + x.type + '/' + x.slug
          });
        });
      };
