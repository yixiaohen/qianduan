...
(function () {
    ...
    var preSelectedLink = function (editor) {
      return function () {
        var a = document.createElement('a');
        var s = getSelectedLink(editor).href;
        a.href = s.replace('Annex/file/', '#/down?id=');
        gotoLink(editor, a);
      };
    };
    ...
    var setupButtons = function (editor) {
      ...
      editor.ui.registry.addButton('prelink', {
        icon: 'preview',
        tooltip: 'Pre link',
        onAction: preSelectedLink(editor),
        onSetup: toggleEnabledState(editor)
      });
    ...
    var setupMenuItems = function (editor) {
      ...
      editor.ui.registry.addMenuItem('prelink', {
        text: 'Pre link',
        icon: 'preview',
        onAction: preSelectedLink(editor),
        onSetup: toggleEnabledState(editor)
    ...
    var setupContextMenu = function (editor) {
      var inLink = 'link unlink openlink prelink';
      var noLink = 'link';
