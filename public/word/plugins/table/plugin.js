...
(function () {
    ...
    var insertColumnsBefore = run(opInsertColumnsBefore, insertColumnsExtractor(true), resize, noop, Generators.modification);
    var insertColumnsAfter = run(opInsertColumnsAfter, insertColumnsExtractor(false), resize, noop, Generators.modification);
    var eraseColumns = run(opEraseColumns, onUnlockedCells, resize, prune, Generators.modification);
    ...
    var mergeCells = run(opMergeCells, onUnlockedMergable, noop, noop, Generators.merging);
